...
#         log_abs_det_jacobian = log_s + log_abs_det_jacobian
...
#         # apply mask
#         u, log_abs_det_jacobian= self.shiesh_act(u,inverse = True)
#         mu = u * self.mask
...
#         log_s = torch.tanh(s) * (1 - self.mask)
#         #u_, log_abs_det_jacobian = self.shiesh_act(u,inverse = True)
...
#         elif activation == "None":  # Add this case
#             activation_fn = nn.Identity()  # No-op activation
#         else:
...
#         u, log_abs_det_jacobian = self.shiesh_act(u,inverse = False)
#         log_abs_det_jacobian = -loga + log_abs_det_jacobian
#         # MAF eq 5
...
#         #x , log_abs_det_jacobian =self.shiesh_act(x,inverse = True)
#         log_abs_det_jacobian = loga + log_abs_det_jacobian
#         #log_abs_det_jacobian = loga
#         return x, log_abs_det_jacobian
