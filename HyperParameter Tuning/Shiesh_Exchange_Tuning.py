...
# %%
from gluonts.dataset.multivariate_grouper import MultivariateGrouper # type: ignore
#import gluonts.torch.distributions.distribution_output
from gluonts.dataset.repository.datasets import dataset_recipes, get_dataset # type: ignore
from pts.model.tempflow import TempFlowEstimator
from pts.model.transformer_tempflow import TransformerTempFlowEstimator
from pts import Trainer
from gluonts.evaluation.backtest import make_evaluation_predictions # type: ignore
from gluonts.evaluation import MultivariateEvaluator # type: ignore
...
n_blocks_list = [2, 3, 4, 5, 6, 7, 8]  # Number of blocks to try
